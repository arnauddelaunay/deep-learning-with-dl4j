package com.example.myapplication.core.preprocessing;
...
public class SentimentExampleIterator implements DataSetIterator {
    ...
    public SentimentExampleIterator(String dataDirectory, WordVectors wordVectors, int batchSize, int truncateLength, boolean train) throws IOException {
        ...
        File p = new File(FilenameUtils.concat(dataDirectory, "aclImdb_simple/" + (train ? "train" : "test") + "/pos/") + "/");
        File n = new File(FilenameUtils.concat(dataDirectory, "aclImdb_simple/" + (train ? "train" : "test") + "/neg/") + "/");
